...
const EmailVerify = () => {
    ...
    const { getUserData, setIsLoggedIn, isLoggedIn, userData, backendURL } = useContext(AppContext);
    ...
    const handleVerify = async () => {
        ...
        setLoading(true);
        try {
            const response = await axios.post(backendURL + "/user/verify-otp", { otp, email, password });
